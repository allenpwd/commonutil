...
public class EncryptUtil {
     ...
     * 默认密钥字节数
     * DH
     * Default Keysize     * Keysize must be a multiple of 64, ranging from 512 to 1024 (inclusive).
     */
    ...
    public static String generateDESKey(String seed) {
        try {
            ...
            System.out.println(TranscodeUtil.byteArrayToHexStr(secretKey.getEncoded()));
            return TranscodeUtil.byteArrayToBase64Str(secretKey.getEncoded());
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
        }
